    ...
    elseif self.human == Find_Player("EMPIRE")
        ...
        then
            ...
            if proteus == "CIS_REMNANTS" then
                self.EMPIREGOV:UpdateDisplay(self.SHIPMARKET.market_types["IMPERIAL_PROTEUS"][proteus]["CIS_MARKET"].market_name, self.SHIPMARKET.market_types["IMPERIAL_PROTEUS"][proteus]["CIS_MARKET"].list)
            else
