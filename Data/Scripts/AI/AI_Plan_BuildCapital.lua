...
function Definitions()
	...
	{
		"StructureForce",
		"Empire_Capital | PA_Capital | Maldrood_Capital | Eriadu_Capital | NewRep_Capital | Rancor_Base | ZE_Capital_Alternate | CSA_Capital | EOTH_Capital | Hapan_Capital | Hutt_Capital | CIS_Capital | CIS_Space_Capital | CIS_Space_Capital2 | CIS_Space_Capital3 | CIS_Space_Capital4 | CIS_Space_Capital5 = 1"
	}
	}
